...
from .models import QueryResponse, DocumentWithHighlights, Highlight, Citation, StructuredAnswer
...
class ResponseBuilder:
    ...
    def build_response(
        ...
        Args:
            ...
            relevant_spans: Dictionary mapping document content to relevant spans
        ...
        # Process each document to create highlights and citations
        for doc_index, doc in enumerate(docs):
            ...
            if doc_spans:
                ...
                highlights = self._create_highlights(doc_content, doc_spans)
