...
class StreamingRAG:
    ...
    async def stream_query(self, question: str, num_docs: int = None) -> AsyncGenerator[Dict[str, Any], None]:
        """
    ...
    def stream_query_sync(self, question: str, num_docs: int = None) -> List[Dict[str, Any]]:
        """
