...
class AnthologyProcessor:
    ...
    def __init__(self, download_dir: str = "downloads/2025_papers", max_retries: int = 3):
    ...
    def process_papers(self, bib_path: str, index_path: str, 
        ...
        if not skip_download:
            ...
            print(f"Metadata extracted for all papers")
...
def main():
    ...
    parser.add_argument(
        "--index-path", 
        required=True, 
        help="Path for the output index"
    )
    parser.add_argument(
        "--download-dir", 
